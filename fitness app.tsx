...
function Tutorial({ firstName, setTab, onClose }) {
  const STEPS = [
    ...
    { tab:"train", title:"Train", body:"All your workouts, grouped in folders \u2014 including ready-made HIIT and Mobility ones. Tap a workout to view it, then Start. Build your own or edit any workout exercise-by-exercise." },
